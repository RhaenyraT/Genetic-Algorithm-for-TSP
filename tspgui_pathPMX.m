...
crossover = uicontrol(ph,'Style','popupmenu', 'String',{'PMX'}, 'Value',1,'Position',[10 50 130 20],'Callback',@crossover_Callback);
...
set(fh,'Visible','on');
    ...
    function runbutton_Callback(hObject,eventdata)
        ...
        run_ga_pathPMX(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, LOCALLOOP, ah1, ah2, ah3);
        end_run();
    end
